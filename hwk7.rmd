...
library(ggplot2)
o_ring_data <- read.table("C:/Users/ea538/Downloads/o_ring_data.txt", header=T, quote="\"")
```
...
qplot(p, samples2, main = "Full Path Over Pi") + xlab("Values of pi") + ylab("Log-likelihood")
```
